...
<c:if test="${sessionScope.user!=null }">
	欢迎您:${sessionScope.user.username }&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/servlet/ClientServlet?operation=logout">注销</a>
</c:if>

<a href="${pageContext.request.contextPath }/servlet/ClientServlet?operation=showUserOrders">我的订单</a>&nbsp;&nbsp;
